 ...
 * input. It contains a number of "rows", each of which contains an optional
 * label and an input. It also has an optional header, which can contain
 * style-dependent functionality.
 * @final
 */
